...
def plot_snr(file_obs, file_snr, constellations=["G", "R", "E", "C"], cmap="plasma", snr_min=10, snr_max=55):
    """
    Generate polar scatter plots of SNR values for specified constellations from observation and SNR files.
    ...
    fig, axs = plt.subplots(len(constellations), 1, subplot_kw=dict(projection="polar"), figsize=(24, 12), dpi=600)
